...
val resultint1 = (case (toInt t5) of 
                        4 => (print "correct 1\n"; true)
                        | _ => (print "Incorrect 1\n"; false))
                        handle _ => (print "Incorrect 1\n"; false);

val resultint2 = (case (toInt t6) of 
                        ~3 => (print "correct 2\n"; true)
                        | _ => (print "Incorrect 2\n"; false))
                        handle _ => (print "Incorrect 2\n"; false);

val resultInt3 = (case (toInt t4) of 
                        _ => (print "Incorrect 3\n"; false))
                        handle Not_int => (print "correct 3\n"; true)
                        handle _ => (print "Incorrect 3\n"; false);

val resultInt4 =  (case (toInt (S (S (Z)))) of 
                        2 => (print "correct\n"; true)
                        | _ => (print "Incorrect 4\n"; false))
                        handle _ => (print "Incorrect 4\n"; false);


(* Test cases for fromString *)
val resultstring1 = (case (fromString "a") of 
                        (VAR "a") => (print "correct 1\n"; true)
                        | _ => (print "Incorrect 1\n"; false))
                        handle Not_wellformed => (print "Incorrect 1\n"; false);

val resultstring2 = (case (fromString "abcd efgh") of 
                        _ => (print "Incorrect 2\n"; false))
                        handle Not_wellformed  => (print "Correct 2\n"; true);

val resultstring3 = (case (fromString "(ITE <F,abc,Z>)") of 
                        ITE (F, VAR("abc"), Z) => (print "correct 3\n"; true)
                        | _ => (print "Incorrect 3\n"; false))
                        handle Not_wellformed => (print "Incorrect 3\n"; false);

val resultstring4 = (case (fromString "(S (S Z))") of 
                        S (S (Z)) => (print "correct 4\n"; true)
                        | _ => (print "Incorrect 4\n"; false))
                        handle Not_wellformed => (print "Incorrect 4\n"; false);
